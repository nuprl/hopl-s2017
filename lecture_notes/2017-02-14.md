...
Interestingly, there's a remark in the paper that lienar logic could be used
...
(the workshop organizer?) and he said his shelf for that conference only went
back to 1993.
...
one pair of their intro and elim forms.
